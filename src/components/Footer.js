        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-6 mb-3">
             ...
             <div className="py-4"><small>All Rights Reserved © Leapsail.com</small></div>
             
             <h6 className="fw-bold">Address:</h6>
             <small>23, Ezekiel street, Off Toyin street, Ikeja</small>
              <div className="mt-5">
                <Link to="/"><img src={apple} alt="" title="Download on Appstore" className="img-fluid me-3" width={120} /></Link>
                <Link to="/"><img src={google} alt="" title="Download on Playstore" className="img-fluid me-3" width={120} /></Link>
              </div>
            </div>
